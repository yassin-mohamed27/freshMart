      ...
      >
        <div
          className="pointer-events-none absolute inset-0 opacity-0 transition duration-300
            group-hover:opacity-100 bg-linear-to-b from-emerald-500/10 via-emerald-400/10 to-transparent"
        />
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <span className="text-xs font-semibold text-zinc-600 group-hover:text-emerald-600 transition">
            View →
          </span>
        </div>
