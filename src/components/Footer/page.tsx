...
export default function Footer() {
    return (
        <footer className="relative border-t border-slate-800 bg-slate-950 text-slate-300">
            <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-green-500/30 to-transparent" />
            ...
            <div className="container mx-auto px-6 py-14">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-xl font-bold bg-linear-to-r from-green-400 via-emerald-400 to-teal-500 bg-clip-text text-transparent">
                            freshMart
                        </h2>
