...
const session = await getServerSession(authOptions);
  ...
  <div className="pointer-events-none absolute bottom-0 right-0 w-[600px] h-[400px] bg-emerald-400/20 blur-[120px] rounded-full" />
  ...
  <div className="relative max-w-7xl mx-auto px-6 py-10">
    ...
    <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-6 sm:p-8 shadow-sm">
      ...
      <div className="relative text-center space-y-3">
        ...
        <div className="mx-auto mt-4 h-1 w-24 rounded-full bg-linear-to-r from-green-600 to-emerald-600" />
      </div>
    </div>
