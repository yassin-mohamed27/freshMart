  ...
  return (
    <CardFooter className="gap-2 p-0 mt-0">
      ...
      <Button
        ...
        className="flex-1 h-11 rounded-xl bg-green-700 text-white font-semibold flex items-center justify-center gap-2
      shadow-sm transition-all duration-300 hover:bg-green-600 hover:shadow-md active:scale-[0.98]
      disabled:opacity-70 disabled:cursor-not-allowed border border-green-800 hover:ring-2 hover:ring-green-900/20"
      >
        {isLoading ? (
      ...
      <button
        ...
        className="grid size-11 place-items-center rounded-xl border border-emerald-300 bg-white shadow-sm
      ...
      >
        {wishLoading ? (
          ...
          <HeartIcon
            className={
              inWishlist ? "size-5 text-green-500 fill-green-500" : "size-5 text-zinc-700"
            }
          />
        )}
      </button>
